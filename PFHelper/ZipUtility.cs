...
namespace Perfect
{
    ...
    /// <summary>
    /// 使用方法：https://www.cnblogs.com/sun-shadow/p/9205510.html
    /// 
    ...
    public class ZipUtility
    {
        ...
        /// <param name="excludeFolder">排除的目录(如.git等超大的文件夹没必要)</param> 
        public void ZipFileFromDirectory(string rootPath, string destinationPath, int compressLevel,string[] excludeFolder=null)
        {
            GetAllDirectories(rootPath, excludeFolder);
            ...
            */
            ...
            {
                //if(excludeFolder==null|| (!excludeFolder.Contains(emptyPath)))
                //{
        ...
        private void GetAllDirectories(string rootPath, string[] excludeFolder = null)
        {
            string[] subPaths = Directory.GetDirectories(rootPath);//得到所有子目录 
            foreach (string path in subPaths)
            {
                if (excludeFolder == null || (!excludeFolder.Any(a=>path.IndexOf(a)==path.Length-a.Length)))
                {
